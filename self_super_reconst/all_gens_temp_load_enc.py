...
def main(argv):
    ...
    prefix = 'jan14-stark_SUPER_Code1_MaxVit_Initnorm_awp_with_grad_1000_steps_1e-2_1e-2-'
    ...
    for sub in subs:
        for roi in roi_list:
            ...
            for cat_idx, c in enumerate(top_10_class):
                ...
                folder = "/hdd_home/achin/projs/saten/xavierNew/AllCode/transferred_Corrected_VGG_Class_Xdream/jan14-stark_SUPER_Code1_MaxVit_Initnorm_awp_with_grad_1000_steps_1e-2_1e-2/Subject%d"%sub+"bg/class%s"%c+"/class_%d_sub%d_%s_seed0_trunc1/backup/"%(c, sub, roi)
