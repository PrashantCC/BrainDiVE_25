...
#running for NSD dataset
flags.DEFINE_enum("roi", 'V1v', ["V1v", "V1d", "V2v", "V2d", "V3v", "V3d", "hV4", "EBA", "FBA-1", "FBA-2", "mTL-bodies", "OFA", "FFA-1", "FFA-2", "mTL-faces", "aTL-faces", "OPA", "PPA", "RSC", "OWFA", "VWFA-1", "VWFA-2", "mfs-words", "mTL-words", "FFA-comb", "V1", "aTL-faces"], '')
...
flags.DEFINE_string('neural_activity_path', "/data6/shubham/PC/data/cortex/cortex_subj_{}.npy", '')
flags.DEFINE_string('image_path', "/data6/shubham/PC/data/image/image_data.h5py", '')

init_cpt_path = lambda : '/data6/shubham/PC/data/results_jointencoder_master_gaziv/checkpoints/sub1/{}.pth.tar'.format(FLAGS.init_cpt_name)
