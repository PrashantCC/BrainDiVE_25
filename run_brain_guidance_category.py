...
for s in [1,2,3,4,5,6,7,8]:
    ...
    for roi_strings in ["prf-visualrois.nii.gz","floc-bodies.nii.gz", "floc-faces.nii.gz", "floc-places.nii.gz", "floc-words.nii.gz", "food", "HCP"]:
        if (not (roi_strings == "food")) and (not (roi_strings == "HCP")):
            ...
            full_path = "/media/internal_8T/BrainDiVE/nsd_data/nsddata/ppdata/subj0{}/func1pt8mm/roi/{}".format(s, roi_strings)  # i made this change from above line
            ...
            hcp_mask = np.load("media/internal_8T/BrainDiVE/NSD_zscored/best_HCP.npy")  

            # nsdgeneral = load_from_nii("/ocean/projects/soc220007p/aluo/rois/subj0{}/nsdgeneral.nii.gz".format(s))
            nsdgeneral = load_from_nii("media/internal_8T/BrainDiVE/nsd_data/nsddata/ppdata/subj0{}/func1pt8mm/roi/nsdgeneral.nii.gz".format(s))
