...
class mypipelineSAG(DiffusionPipeline):
    ...
    def cond_fn(self,
        ...
        return noise_pred, latents, -loss1.item()
    ...
    def __call__(
        ...
        for i, t in enumerate(timesteps):
            ...
            if clip_guidance_scale > 0:
                ...
                noise_pred, latents, activity = self.cond_fn(
                    latents,
                    t,
                    i,
                    text_embeddings_for_guidance,
        ...
        return StableDiffusionPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept), activity_vector
