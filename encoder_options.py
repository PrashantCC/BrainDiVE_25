...
class Options():
    ...
    def initialize(self):
        ...
        parser.add_argument('--save_loc', default=paths.sav_loc, type=str) # Where are weights saved
        
        parser.add_argument('--subject_id', default=["5"], nargs='+') # Put just a single subject here
        ...
        # The below 3 lines are commented by author itself
        ...
        parser.add_argument("--functional", default = "floc-bodies", type = str)
        parser.add_argument("--region", default="EBA", type = str)
